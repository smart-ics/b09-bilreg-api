...
(
    ...
    fs_kd_detil_tarif VARCHAR(3) NOT NULL CONSTRAINT DF_ta_trs_billing2_fs_kd_detil_tarif DEFAULT(''),
    fs_kd_grup_rek VARCHAR(5) NOT NULL CONSTRAINT DF_ta_trs_billing2_fs_kd_grup_rek DEFAULT(''),
    fs_kd_trs_bayar VARCHAR(26) NOT NULL CONSTRAINT DF_ta_trs_billing2_fs_kd_trs_bayar DEFAULT(''),
    fs_kd_jenis_bayar VARCHAR(5) NOT NULL CONSTRAINT DF_ta_trs_billing2_fs_kd_jenis_bayar DEFAULT(''),
