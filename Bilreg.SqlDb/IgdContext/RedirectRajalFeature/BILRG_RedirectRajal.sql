CREATE TABLE BILRG_RedirectRajal (
    RedirectRajalId VARCHAR(26) NOT NULL CONSTRAINT DF_BILRG_RedirectRajal_RedirectRajalId DEFAULT(''),
    IgdVisitId VARCHAR(26) NOT NULL CONSTRAINT DF_BILRG_RedirectRajal_IgdVisitId DEFAULT(''),
