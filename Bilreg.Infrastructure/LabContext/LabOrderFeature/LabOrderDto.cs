    ...
    DateTime VodDate)
{
    ...
    public static LabOrderDto FromModel(LabOrderModel model)
        => new(
            ...
            LastBillingReleaseStatus: (int)model.LastBillingReleaseStatus,
            ...
            LastBillingReleaseCheckAt: model.LastBillingReleaseCheckAt,
            LastBillingReleaseCheckUserId: model.LastBillingReleaseCheckUserId,
            LastBillingReleaseMessage: model.LastBillingReleaseMessage,
