...
//         var order = OrderTdkModel.Create(auditOrderTdk, pasien.ToReff(), reg.ToReff(), ppa.ToReff(), 
...
//         
//         // RESPONSE
//         return Task.FromResult(new OrderTindakanCreateResponse(order.OrderTdkId));
//     }
//
