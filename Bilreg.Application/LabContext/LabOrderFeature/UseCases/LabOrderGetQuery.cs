...
public class LabOrderGetHandler : IRequestHandler<LabOrderGetQuery, LabOrderGetResponse>
{
    ...
    public Task<LabOrderGetResponse> Handle(LabOrderGetQuery request, CancellationToken cancellationToken)
    {
        ...
        var response = new LabOrderGetResponse(
            ...
            LastBillingReleaseStatus: (int)order.LastBillingReleaseStatus,
            ...
            LastBillingReleaseCheckAt: order.LastBillingReleaseCheckAt,
            LastBillingReleaseCheckUserId: order.LastBillingReleaseCheckUserId,
            LastBillingReleaseMessage: order.LastBillingReleaseMessage,
