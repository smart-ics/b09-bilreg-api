...
public static class InfrastructureService
{
        ...
        IConfiguration configuration)
    {
        ...
        {
            typeof(Bilreg.Infrastructure.InfrastructureAssemblyAnchor).Assembly,
            typeof(Farinv.Infrastructure.InfrastructureAssemblyAnchor).Assembly
        };

        services.Scan(scan => scan
            .FromAssemblies(infraAssemblies)
