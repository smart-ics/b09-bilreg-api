...
public class IgdVisitDalTest
{
    ...
    private static IgdVisitDto Faker()
        => new IgdVisitDto(
            ...
            TriageLevel     : "P3",
            TriageColor     : "GREEN",
            LastTriageAt    : new DateTime(2026,1,10,15,20,25),
            NextReTriageAt  : new DateTime(2026,1,10,22,0,0),
            ...
            CrtUser         : "U1", 
            CrtDate         : new DateTime(2026, 1, 1, 8, 0, 0),
            UpdUser         : "U1", 
            UpdDate         : new DateTime(2026, 1, 1, 8, 0, 0),
            VodUser         : "", 
