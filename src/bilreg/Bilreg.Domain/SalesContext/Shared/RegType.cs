...
namespace Bilreg.Domain.SalesContext.Shared;

/// <summary>
/// Pharmacy registration snapshot used by Resep/Telaah (formerly under Sales AntrianFeature).
/// Kept separate from Admisi RegFeature types.
/// </summary>
