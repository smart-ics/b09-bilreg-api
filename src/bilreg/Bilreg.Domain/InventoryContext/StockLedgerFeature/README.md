...
**S1-A1 Done** (domain skeleton + §8 DDL). **S1-A2 Done** (DAL/Repo/OCC + UoW contract shell). **S1-B Done** (outbound allocation FEFO/FIFO/Explicit ED — pure domain). **S1-C1 Done** (legacy read + UC-STL-010 hydrate). Next: **S1-C2** (catch-up + freshness gate); allocator consumed by S1-E / S1-F*.
