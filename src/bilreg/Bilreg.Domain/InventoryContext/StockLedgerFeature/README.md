...
**S1-A1 Done** (domain skeleton + §8 DDL). **S1-A2 Done** (DAL/Repo/OCC + UoW contract shell). **S1-B Done** (outbound allocation FEFO/FIFO/Explicit ED — pure domain). **S1-C1 Done** (legacy read + UC-STL-010 hydrate). **S1-C2 Done** (catch-up UC-STL-011 + freshness gate UC-STL-012). **S1-D1 Done** (legacy writer + atomic consequence UoW). **S1-D2 Done** (UC-STL-001 Post Goods Receipt Consequence). Next: **S1-E** (UC-STL-002 Post Stock Transfer Consequence).
