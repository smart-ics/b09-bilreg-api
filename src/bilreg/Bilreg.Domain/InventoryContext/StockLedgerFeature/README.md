...
**S1-A1 Done** (domain skeleton + §8 DDL). **S1-A2 Done** (DAL/Repo/OCC + UoW contract shell). **S1-B Done** (outbound allocation FEFO/FIFO/Explicit ED — pure domain). **S1-C1 Done** (legacy read + UC-STL-010 hydrate). **S1-C2 Done** (catch-up UC-STL-011 + freshness gate UC-STL-012). **S1-D1 Done** (legacy writer + atomic consequence UoW). Next: **S1-D2** (UC-STL-001 Post Goods Receipt Consequence on top of UoW + gate).
