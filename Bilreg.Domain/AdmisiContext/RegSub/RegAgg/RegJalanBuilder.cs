...
//     {
//         var regOutFlag = new ActivityFlagVo(regOutDate, userId);
...
//     {
//         var regOUtFlag = new ActivityFlagVo(new DateTime(3000, 1, 1), string.Empty);
//         _agg.SetRegOutFlag(regOUtFlag);
//         return this;
//     }
//
...
//     {
//         var voidFlag = new ActivityFlagVo(tglJam, userId);
...
//     {
//         var voidFlag = new ActivityFlagVo(new DateTime(3000, 1, 1), string.Empty);
//         _agg.SetVoidFlag(voidFlag);
//         return this;
//     }
//
