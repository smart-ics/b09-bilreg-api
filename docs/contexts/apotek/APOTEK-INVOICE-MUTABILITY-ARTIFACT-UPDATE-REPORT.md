...
| **BR-APT-118** | Post-SO shortage → Unfulfilled Outcome plus Credit Note/Refund when commercial consequences exist | Unfulfilled Outcome and Salinan Resep unchanged. Commercial consequences follow **BR-APT-027**. |
