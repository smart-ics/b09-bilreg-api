...
**Bahasa Indonesia companion:** [SOP APT-RJ-005 — Memenuhi Obat dengan Coverage Campuran](./SOP-APT-RJ-005-Fulfill-Mixed-Coverage-Medication-ID.md)
...
18. **Inventory** supplies the Inventory Issue outcomes; **Pharmacy System** displays final Dispense Order and Pharmacy Sales Order progress.
...
- [Apotek Domain](../apotek-domain.md), especially `BR-APT-015`, `BR-APT-020`–`BR-APT-028`, `BR-APT-040`–`BR-APT-046`, `BR-APT-056`–`BR-APT-060`, `BR-APT-070`–`BR-APT-078`, and `BR-APT-090`–`BR-APT-095`.
