...
- CPOE memiliki Clinical Order intent, authorization, routing, lifecycle coordination, serta exceptional-order accountability. RNA menerima pekerjaan dan mengirim Service Execution Fact bila berlaku.
...
- `docs/contexts/cpoe/CPOE-DOMAIN.md` digunakan hanya untuk batas Clinical Order, receiver coordination, exceptional-order accountability, dan outcome delivery.
...
| [SOP-RNA-S01 — Pencatatan Pelaksanaan Service Berdasarkan Clinical Order](SOP-RNA-S01-Pelaksanaan-RNA-Service-Berdasarkan-Clinical-Order.md) | Performer RUANG RANAP | Clinical Order diarahkan ke RNA; Service billable dipilih dari daftar Tarif eligible untuk Layanan Bangsal, atau eksekusi non-billable memiliki description | Service Execution Fact tercatat; hanya billable yang dipublikasikan ke Tindakan | RNA 10.7, 10.9, 10.11 | Upstream: CPOE dan Tarif; downstream: S04; bila salah: S03 |
| [SOP-RNA-S02 — Pencatatan Tindakan Ad Hoc atau Independen](SOP-RNA-S02-Pelaksanaan-Tindakan-Ad-Hoc-atau-Independen.md) | Performer RUANG RANAP | Tindakan dilakukan secara sah tanpa Clinical Order prospektif individual | Service Execution Fact tercatat dengan sumber, dasar kewenangan, kronologi yang benar, serta Service eligible bila billable atau description bila non-billable | RNA 10.8 dan 10.9; CPOE Exceptional Action | Upstream: Tarif; downstream: S04; bila salah: S03 |
| [SOP-RNA-S03 — Koreksi Service Execution Fact](SOP-RNA-S03-Koreksi-RNA-Service-Execution.md) | Aktor koreksi RUANG RANAP yang berwenang | Kesalahan fakta pelaksanaan teridentifikasi | Riwayat asli dipertahankan dan correction fact dipublikasikan | RNA 10.10 Execution Correction | Upstream: S01/S02; downstream: CPOE dan/atau S04 |
...
- Pengelolaan pekerjaan pending, identifikasi occurrence, dan assignment opsional kepada Performer merupakan rangkaian awal S01; semuanya bukan bukti pelaksanaan.
