...
| UC-AQO-022 | Target | Complete Registration without Prior Intake | Command collaboration | Create Registration without synthetic queue participation | Admisi Rajal Registration | Registration / Tracker evidence | Registration repos, tracker repo | Registration commits without Queue Session, Queue Entry, claim, or outcome |
