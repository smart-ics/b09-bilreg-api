...
|-------------|------------|------|
| Apply scripts in [manifest](../../../src/bilreg/Bilreg.SqlDb/AdmisiContext/BILRG_AdmissionQueue_MigrationManifest.md) order | Confirm tables/indexes via SQL or rollout status | [ ] |
