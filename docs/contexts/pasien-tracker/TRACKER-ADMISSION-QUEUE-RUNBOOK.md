...
| [TRACKER-ADMISSION-QUEUE-KIOSK-DISPLAY-DEPLOY-ID.md](./TRACKER-ADMISSION-QUEUE-KIOSK-DISPLAY-DEPLOY-ID.md) | Panduan deploy/konfigurasi Kiosk + Display (Bahasa Indonesia; IT RS) |
